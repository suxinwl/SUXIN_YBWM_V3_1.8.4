...
use App\Jobs\MakeAccountJob;
use App\Jobs\MiniAuditJob;
use Swoole\Table;
...
return [
    ...
    */
    ...
    'listen_port' => env('LARAVELS_LISTEN_PORT', 5300),
    ...
    */
    ...
    'server' => env('LARAVELS_SERVER', 'Ybv3'),
    ...
    */
    ...
    'processes' => [
        // 'queue' => [ // Key为进程名
        //     'class'    => \App\Processes\QueueProcess::class,
    ...
    */
    ...
    'cleaners' => [
        ...
        App\Services\LaravelS\JWTCleaner::class,
    ],
    ...
    */
    ...
    'destroy_controllers' => [
        ...
        'excluded_list' => [
            ...
            // ChannelApiApiController::class,
            // NotifyApiController::class
        ],
    ],
