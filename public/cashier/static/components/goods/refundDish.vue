<template>
	<u-overlay :show="giftDish" :opacity="0.2">
		<view class="reduce bf p15 f18 f-y-bt" @tap.stop>
			<view class="f-x-bt">
				<view class="f-c f-g-1 wei f24">退菜</view>
			...
			<view class="uScroll pb10">
				...
				<view class="f-x-e mb10">
					<view class="f14 c9">商品最多可退<text class="cf5">{{selectItem.num}}</text>份</view>
				</view>
				<!-- <view class="key">
				...
				<view class="">
					<view class="m15 c9 f14">退菜原因<text class="cf5 wei6 f15 pl5">*</text></view>
					<creason :list="reasonConfig && reasonConfig.backGoods" @getRemark="getRemark" />
				</view>
			</view>
	...
	export default {
		...
		data(props) {
			return {
				...
				iCount: '',
				resons: [],
				list: ['未按要求制作', '不新鲜', '发现异物', '上菜慢', '错点', '多点'],
			}
		},
		computed: {
			...mapState({
