<template>
	<u-overlay :show="show" :opacity="0.2" @click="close">
		<view class="reduce bf f18 f-y-bt" @tap.stop>
			<view class="dfbc p20">
				<view class="f-c f-g-1 wei f24">免单确认</view>
				<!-- <text class="iconfont icon-cuowu" @click="close"></text> -->
			</view>
			<view class="p-0-20">
				<view class="m15 c9 f14">免单原因<text class="cf5 pl5 wei6 f15">*</text></view>
				<creason :list="reasonConfig && reasonConfig.orderFree" @getRemark="getRemark" />
			</view>
			<view class="p20 f-e butt">
				...
				<view>
					<u-button @click="saveOrder" color="#4275F4"><text class="f18 wei6 p10">免单并结账</text></u-button>
				</view>
			</view>
		</view>
