...
//聚合支付
use App\Models\SuiXingFu\SxfClient;

class TradeJsApiScan
{
    public static function pay()
    {
        ...
        $array = [
            ...
            "userId" => "ok-gG5EtzrRVHRgQ6hJcTr7bs7_o"        //"2088022823326552", //用户号 微信：openid； 支付宝：userid；银联：userid；微信&支付宝必传，银联js为非必传
        ...
        if ($verify) {
            echo ("验签成功");
            echo "--------------\n";
            echo json_encode($result['respData'],320);
            echo "--------------\n";
        } else {
            echo ("验签失败");
        }
