...
namespace App\Models\KuaiShou\Kernel;

use App\Models\KuaiShou\Kernel\Contracts\MessageInterface;
use App\Models\KuaiShou\Kernel\Exceptions\BadRequestException;
use App\Models\KuaiShou\Kernel\Exceptions\InvalidArgumentException;
use App\Models\KuaiShou\Kernel\Messages\Message;
use App\Models\KuaiShou\Kernel\Messages\News;
use App\Models\KuaiShou\Kernel\Messages\NewsItem;
use App\Models\KuaiShou\Kernel\Messages\Raw as RawMessage;
use App\Models\KuaiShou\Kernel\Messages\Text;
use App\Models\KuaiShou\Kernel\Support\XML;
use App\Models\KuaiShou\Kernel\Traits\Observable;
use App\Models\KuaiShou\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
     ...
     * @return $this
     *
     * @throws \App\Models\KuaiShou\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\App\Models\KuaiShou\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \App\Models\KuaiShou\Kernel\Exceptions\InvalidArgumentException
     * @throws \App\Models\KuaiShou\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \App\Models\KuaiShou\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \App\Models\KuaiShou\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \App\Models\KuaiShou\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
