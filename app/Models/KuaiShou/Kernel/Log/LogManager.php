...
namespace App\Models\KuaiShou\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('App\Models\KuaiShou', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/App\Models\KuaiShou/App\Models\KuaiShou.log',
    ...
    protected function createSlackDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SlackWebhookHandler(
                $config['url'],
                $config['channel'] ?? null,
                $config['username'] ?? 'App\Models\KuaiShou',
    ...
    {
        return $config['name'] ?? 'App\Models\KuaiShou';
    }
