...
class Client extends BaseClient
{
    ...
    {
        $cacheKey = sprintf('App\Models\KuaiShou.basic_service.jssdk.ticket.%s.%s', $type, $this->getAppId());
