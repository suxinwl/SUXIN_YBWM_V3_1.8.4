...
use App\Models\Wechat\Kernel\Exceptions\BadResponseException;
...
class ResponseValidator implements \App\Models\Wechat\Pay\Contracts\ResponseValidator
{
    public const  MAX_ALLOWED_CLOCK_OFFSET = 300;
    public const  HEADER_TIMESTAMP = 'App\Models\Wechatpay-Timestamp';
    public const  HEADER_NONCE = 'App\Models\Wechatpay-Nonce';
    public const  HEADER_SERIAL = 'App\Models\Wechatpay-Serial';
    public const  HEADER_SIGNATURE = 'App\Models\Wechatpay-Signature';
    ...
    /**
     * @throws \App\Models\Wechat\Kernel\Exceptions\BadResponseException
    ...
    public function validate(ResponseInterface $response): void
    {
        ...
        if (!$publicKey) {
            throw new InvalidConfigException(
                ...
                please download from App\Models\Wechat pay and set it in merchant config with key `certs`."
            );
        }
