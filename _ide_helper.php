...
')
     ...
     */ 
         ...
         * 
         *
         * @param \iBrand\Sms\Storage\StorageInterface $storage
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function send($to, $data = [], $gateways = [])
        {
                        /** @var \iBrand\Sms\Sms $instance */
                        return $instance->send($to, $data, $gateways);
        }
                    /**
         * check china mobile.
         *
         ...
         * @static 
         */ 
        public static function verifyMobile($to)
        {
                        /** @var \iBrand\Sms\Sms $instance */
                        return $instance->verifyMobile($to);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getCodeFromStorage()
        {
                        /** @var \iBrand\Sms\Sms $instance */
                        return $instance->getCodeFromStorage();
        }
                    /**
         * 
         *
         * @param $to
         * @return \iBrand\Sms\Code 
         * @static 
         */ 
        public static function getNewCode($to)
        {
                        /** @var \iBrand\Sms\Sms $instance */
                        return $instance->getNewCode($to);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function canSend($to)
        {
                        /** @var \iBrand\Sms\Sms $instance */
                        return $instance->canSend($to);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function generateCode($to)
        {
                        /** @var \iBrand\Sms\Sms $instance */
                        return $instance->generateCode($to);
        }
                    /**
         * 
         *
         * @return \iBrand\Sms\Storage\CacheStorage|\iBrand\Sms\Storage\StorageInterface 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function checkCode($to, $inputCode)
        {
                        /** @var \iBrand\Sms\Sms $instance */
                        return $instance->checkCode($to, $inputCode);
        }
...
namespace  { 
             ...
             * @static 
             */ 
            public static function orderByWith($relation, $column, $direction = 'asc')
            {
                                return \Illuminate\Database\Eloquent\Builder::orderByWith($relation, $column, $direction);
            }
            ...
            class Sms extends \iBrand\Sms\Facade {}
